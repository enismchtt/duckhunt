...
public class Level4 extends Pane {
    ...
    private double birdSpeed1X = 60 * DuckHunt.SCALE / 3;
    ...
    public Level4() {
        ...
        birdView2.setLayoutY(100 * DuckHunt.SCALE / 3);


        //creating text
        Text level = new Text("Level 4/6");
    ...
    private void animateBird() {
        ...
        // Update bird frame
        currentFrameIndex = (currentFrameIndex + 1) % firstBirdCrossedImages.length;
        birdView1.setImage(firstBirdCrossedImages[currentFrameIndex]);
        currentFrameIndex = (currentFrameIndex + 1) % firstBirdCrossedImages.length;
        birdView1.setImage(firstBirdCrossedImages[currentFrameIndex]);

        currentFrameIndex = (currentFrameIndex + 1) % secondBirdCrossedImages.length;
        birdView2.setImage(secondBirdCrossedImages[currentFrameIndex]);
        currentFrameIndex = (currentFrameIndex + 1) % secondBirdCrossedImages.length;
        birdView2.setImage(secondBirdCrossedImages[currentFrameIndex]);
