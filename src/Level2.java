...
public class Level2 extends Pane {
    ...
    private  double birdSpeedX = 60 * DuckHunt.SCALE / 3;
    private  double birdSpeedY = -50 * DuckHunt.SCALE / 3;
    ...
    private Image[] birdCrossedImages = new Image[3];
    ...
    public Level2() {
        ...
        birdCrossedImages[0] = new Image("assets/duck_blue/1.png");
        birdCrossedImages[1] = new Image("assets/duck_blue/2.png");
        birdCrossedImages[2] = new Image("assets/duck_blue/3.png");

        birdFallImages[0] = new Image("assets/duck_red/7.png");
        birdFallImages[1] = new Image("assets/duck_red/8.png");

        birdView = new ImageView(birdCrossedImages[0]);
    ...
    private void animateBird() {
        ...
        birdView.setLayoutX(birdView.getLayoutX() + birdSpeedX);
        birdView.setLayoutY(birdView.getLayoutY() + birdSpeedY);

        // Update bird frame
        currentFrameIndex = (currentFrameIndex + 1) % birdCrossedImages.length;
        birdView.setImage(birdCrossedImages[currentFrameIndex]);
        ...
        if(birdView.getLayoutY() <= 0 || birdView.getLayoutY() >= getHeight() - BIRD_HEIGHT){
            birdSpeedY = -birdSpeedY;
            birdView.setScaleY(birdView.getScaleY() * -1); // Flip bird vertically
        }
