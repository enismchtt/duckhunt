...
public class Level5 extends Pane {
    ...
    private double birdSpeed2X = 60 * DuckHunt.SCALE / 3;
    private  double birdSpeed2Y = -50 * DuckHunt.SCALE / 3;
    private double birdSpeed3 = 90 * DuckHunt.SCALE / 3;
    ...
    private Image[] thirdBirdHorizontalImages = new Image[3];
    ...
    public Level5() {
        ...
        secondBirdHorizontalImages[0] = new Image("assets/duck_black/1.png");
        secondBirdHorizontalImages[1] = new Image("assets/duck_black/2.png");
        secondBirdHorizontalImages[2] = new Image("assets/duck_black/3.png");

        thirdBirdHorizontalImages[0] = new Image("assets/duck_blue/4.png");
        thirdBirdHorizontalImages[1] = new Image("assets/duck_blue/5.png");
        thirdBirdHorizontalImages[2] = new Image("assets/duck_blue/6.png");
        ...
        birdView1.setLayoutX(450*DuckHunt.SCALE/3);
        birdView1.setLayoutY(300*DuckHunt.SCALE/3);

        birdView2 = new ImageView(secondBirdHorizontalImages[0]);
        birdView2.setFitWidth(BIRD_WIDTH);
        birdView2.setFitHeight(BIRD_HEIGHT);
        birdView2.setLayoutY(200*DuckHunt.SCALE/3);

        birdView3 = new ImageView(thirdBirdHorizontalImages[0]);
        birdView3.setFitWidth(BIRD_WIDTH);
        birdView3.setFitHeight(BIRD_HEIGHT);
        birdView3.setLayoutY(150*DuckHunt.SCALE/3);
    ...
    private void animateBird() {
        ...
        // third bird
        birdView3.setLayoutX(birdView3.getLayoutX() + birdSpeed3);
        ...
        // third bird
        currentFrameIndex3 = (currentFrameIndex3 + 1) % thirdBirdHorizontalImages.length;
        birdView3.setImage(thirdBirdHorizontalImages[currentFrameIndex3]);
